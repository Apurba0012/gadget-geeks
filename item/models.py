...
from home.models import Category, Customer, Sub_Category
...
class Products(models.Model):
    ...
    sc_id = models.ForeignKey(Sub_Category, related_name='p_sca_id', default='1', on_delete=models.SET_NULL, null=True)


class Cart(models.Model):
    cart_id= models.IntegerField(primary_key=True)
    cart_totalAmmount= models.FloatField(max_length=20)
    c_id = models.ForeignKey(Customer,related_name='c_p_c_id', default='1', on_delete=models.SET_NULL,null=True)
...
class Review(models.Model):
    ...
    star = models.ForeignKey(Products, default='1', on_delete=models.SET_NULL,null=True)
